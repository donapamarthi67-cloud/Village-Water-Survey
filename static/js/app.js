...
function toggleLanguage(){lang=lang==="en"?"te":"en";localStorage.setItem("siteLang",lang);applyLanguage();}
...
function useLocation(){
  ...
  navigator.geolocation.getCurrentPosition(p=>{
    document.querySelector("#latitude").value=p.coords.latitude;
    document.querySelector("#longitude").value=p.coords.longitude;
